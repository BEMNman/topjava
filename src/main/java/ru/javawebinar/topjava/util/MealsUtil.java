...
public class MealsUtil {
    private static List<Meal> meals = Arrays.asList(
        ...
        new Meal(LocalDateTime.of(2015, Month.JUNE, 28, 23, 6), "Ужин", 295),
        new Meal(LocalDateTime.of(2015, Month.JUNE, 28, 8, 0), "Завтрак", 706),
        new Meal(LocalDateTime.of(2015, Month.JUNE, 28, 14, 28), "Обед", 1000)
);
